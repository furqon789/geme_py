...
base_size = max(14, W // 60)
FONT = pygame.font.SysFont("arial", base_size)
FONT_BOLD = pygame.font.SysFont("arial", base_size, bold=True)
FONT_TITLE = pygame.font.SysFont("arial", max(22, W // 40), bold=True)
FONT_SMALL = pygame.font.SysFont("arial", max(11, W // 80))
